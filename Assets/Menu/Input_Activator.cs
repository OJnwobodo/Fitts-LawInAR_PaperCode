...
public class Input_Activator : MonoBehaviour
{
    ...
    private void SaveToFile()
    {
        ...
        using (StreamWriter writer = new StreamWriter(filePath, true))
        {
            ...
            writer.WriteLine($"{UsernameKey}:{usernameInputField.text}");
            writer.WriteLine($"{SessionIdKey}:{sessionIdInputField.text}");
            writer.WriteLine($"{NofSamplesKey}:{nofSamplesInputField.text}");
        }
    }
